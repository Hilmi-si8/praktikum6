                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="form_pasien.php"><button class="btn btn-dark mb-1">Tambah Data</button></a>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td><a href='edit_pasien.php?id=" . $row['id'] . "' class='btn btn-warning'>Edit</a>  <a href='hapus_pasien.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
